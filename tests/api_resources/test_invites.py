...
class TestInvites:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_decline(self, client: LlamaCloudAdmin) -> None:
        invite = client.invites.decline(
            "invite_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_list_mine_with_all_params(self, client: LlamaCloudAdmin) -> None:
        invite = client.invites.list_mine(
            page_size=0,
...
class TestAsyncInvites:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_decline(self, async_client: AsyncLlamaCloudAdmin) -> None:
        invite = await async_client.invites.decline(
            "invite_id",
        )
        assert invite is None
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_list_mine_with_all_params(self, async_client: AsyncLlamaCloudAdmin) -> None:
        invite = await async_client.invites.list_mine(
            page_size=0,
            page_token="page_token",
        )
