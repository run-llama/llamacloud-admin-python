...
from ..types import invite_list_mine_params
...
class InvitesResource(SyncAPIResource):
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> InviteAcceptResponse:
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> SyncPaginatedCursor[Invite]:
        """
        ...
        return self._get_api_list(
            ...
            }, invite_list_mine_params.InviteListMineParams)),
            model=Invite,
        )
...
class AsyncInvitesResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> AsyncPaginator[Invite, AsyncPaginatedCursor[Invite]]:
        """
        List the current user's pending invitations, cursor-paginated.
