...
from ..types import project_delete_params
from ..types import project_get_params
...
class ProjectsResource(SyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> SyncPaginatedCursor[Project]:
    ...
    *,
    ...
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> None:
        ...
        return self._delete(
            ...
            options=make_request_options(extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout, query=maybe_transform({
                "organization_id": organization_id
            }, project_delete_params.ProjectDeleteParams)),
            cast_to=NoneType,
        )
...
class AsyncProjectsResource(AsyncAPIResource):
    ...
    *,
    ...
    extra_query: Query | None = None,
    extra_body: Body | None = None,
    timeout: float | httpx.Timeout | None | NotGiven = not_given,) -> AsyncPaginator[Project, AsyncPaginatedCursor[Project]]:
        """List projects in an organization.
